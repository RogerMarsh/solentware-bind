...
It is assumed solentware_grid.datagrid.DataGrid will be a superclass
whenever the classes in this module are a superclass, but behaviour
when this is not so is undefined.
